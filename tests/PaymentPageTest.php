...
namespace atlantpayments\tests;

use atlantpayments\PaymentPage;
use atlantpayments\SignatureHandler;
use atlantpayments\Payment;
...
class PaymentPageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetUrl()
    {
        ...
        self::assertEquals(
            'https://paymentpage.atlantpayments.com/payment?project_id=100&interface_type=%7B%22id%22%3A23%7D'
